...
const AdminPage = () => {
  ...
  const getResult = async () => {
    const response = await fetch(`http://localhost:5000/api/currentgame/currentgame/67e5c15fa1d92ba58cfd680d`)
  ...
  const updateResult = async (num, bla) => {
    if (num == 1) {
      if (bla === 0) {
        const response = await fetch(`http://localhost:5000/api/currentgame/result1/67e5c15fa1d92ba58cfd680d`, {
          method: "PUT", // or "PATCH"
      ...
      if (bla === 0) {
        const response = await fetch(`http://localhost:5000/api/currentgame/result2/67e5c15fa1d92ba58cfd680d`, {
          method: "PUT", // or "PATCH"
          headers: { "Content-Type": "application/json" },
  ...
  const updateSetResult = async (num, reset) => {
    if (num == 1) {
      if (reset === 0) {
        const response = await fetch(`http://localhost:5000/api/currentgame/set1/67e5c15fa1d92ba58cfd680d`, {
          method: "PUT", // or "PATCH"
          headers: { "Content-Type": "application/json" },
      ...
      if (reset === 0) {
        const response = await fetch(`http://localhost:5000/api/currentgame/set2/67e5c15fa1d92ba58cfd680d`, {
          method: "PUT", // or "PATCH"
          headers: { "Content-Type": "application/json" },
  ...
  const saveGame = async () => {
    const { success, message } = await fetch(`http://localhost:5000/api/game/`, {
